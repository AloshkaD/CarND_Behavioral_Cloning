...
def telemetry(sid, data):
    ...
    # Get the region of the image from the approx. horizon and car and full width.
    # Each 2nd pixel in horizontal and vertical direction is taken to have smaller input dataset
